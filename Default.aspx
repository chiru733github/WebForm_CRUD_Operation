...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="w-100" style="height: 207px; background-color: #FFFF00;">
        <tr>
        ...
        <tr>
            <td style="padding-left: 300px; color: #FF00FF;">
        ...
        <tr>
            <td style="padding-left: 300px; color: #FF00FF; height: 34px;">
        ...
        <tr>
            <td style="text-align: center; letter-spacing: 3em; padding-top: 15px; padding-bottom: 15px; height: 69px;" colspan="2">
                <asp:Button ID="Button1" runat="server" BackColor="#66FF33" Font-Size="Medium" ForeColor="White" OnClick="Insert_Click" Text="Insert" Width="100px" />
&nbsp;<asp:Button ID="Button2" runat="server" BackColor="#FF9933" Font-Size="Medium" ForeColor="White" OnClick="Update_Click" Text="Update" Width="100px" />
&nbsp;<asp:Button ID="Button3" runat="server" BackColor="Red" Font-Size="Medium" ForeColor="White" OnClick="Delete_Click" OnClientClick="return confirm('Are you sure to delete ?');" Text="Delete" Width="100px" />
            &nbsp;<asp:Button ID="Button5" runat="server" BackColor="Blue" Font-Size="Medium" ForeColor="White" OnClick="Fetch_Click" Text="Fetch" Width="100px" />
            &nbsp;<asp:Button ID="Button4" runat="server" BackColor="#CC3300" Font-Size="Medium" ForeColor="White" OnClick="Clear_Click" Text="Clear" Width="100px" />
            &nbsp;<asp:Button ID="Button6" runat="server" BackColor="#9900FF" Font-Size="Medium" ForeColor="White" OnClick="FetchBYName_Click" Text="FetchBYName" Width="136px" />
            </td>
        </tr>
        <tr>
